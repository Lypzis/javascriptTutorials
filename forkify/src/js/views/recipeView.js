...
// returns an array, but a string is necessary for the html, so, 'join' is used when finished everything
...
export const updateServingsIngredients = recipe => {
    ...
    countElements.forEach((el, i) => {
        // index needed, because each recipe has an array of ingredients
        el.textContent = formatCount(recipe.ingredients[i].count); // used here;
    });
}